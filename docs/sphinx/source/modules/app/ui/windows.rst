...
This module contains the top-level windows and dialogs of the Fluvel
application.

These components provide the main entry points for image processing,
video processing, analysis and application configuration workflows.
